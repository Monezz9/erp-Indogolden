    ...
    public function menus(): array
    {
        ...
        return [
            ...
            'pengadaan' => [
                ...
                'accent' => 'amber',
                'subtitle' => 'Catat barang datang, stok masuk, histori pengadaan, dan data supplier.',
                'items' => [
                    $this->item('Pengadaan', 'Input barang datang lalu langsung masuk stok dan finance.', 'heroicon-o-clipboard-document-list', ProcurementRequestWorkspace::getUrl(), 'Input Pengadaan'),
                    $this->item('Histori Pengadaan', 'Lihat daftar transaksi pengadaan dan detail barang masuk.', 'heroicon-o-list-bullet', ProcurementHistory::getUrl(), 'Buka Histori'),
            ...
            'finance' => [
                ...
                'accent' => 'sky',
                'subtitle' => 'Pencatatan pemasukan, pengeluaran, dan kontrol HPP.',
                'items' => [
