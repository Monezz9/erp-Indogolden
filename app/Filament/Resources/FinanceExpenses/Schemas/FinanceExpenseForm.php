...
class FinanceExpenseForm
{
        ...
        return $schema
            ...
            ->components([
                Grid::make(1)
                    ->schema([
                        Section::make('Informasi Transaksi')
                            ->description('Identitas biaya atau kas keluar.')
                        ...
                        Section::make('Nominal & Pembayaran')
                            ->description('Pilih kanal uang keluar dan nominal biaya.')
                            ...
                            ->schema([
                                ...
                                ToggleButtons::make('payment_method')
                                    ...
                                    ->colors([
                                        PaymentMethod::Cash->value => 'danger',
                        ...
                        Section::make('Catatan')
                            ->description('Catatan biaya akan menjadi deskripsi di Buku Kas.')
                ...
                Section::make('Preview Transaksi')
                    ->description('Ringkasan yang akan muncul sebagai kredit di Buku Kas.')
                    ->icon('heroicon-o-eye')
                    ->extraAttributes(['class' => 'ig-finance-preview ig-finance-preview--expense'])
                    ->schema([
                        ...
                        \Filament\Forms\Components\Placeholder::make('flow')
                            ...
                            ->content(new HtmlString('
                                <div class="ig-finance-flow">
                                    ...
                                    <ol>
                                        <li>Input biaya.</li>
                                        <li>Masuk Buku Kas.</li>
                                        <li>Saldo berkurang.</li>
                                        <li>Bisa diexport.</li>
                                    </ol>
                                </div>
                            ')),
    ...
    protected static function preview(Get $get): HtmlString
    {
        ...
        $supplier = $get('supplier_id') ? Supplier::query()->find($get('supplier_id'))?->name : null;
        ...
        return new HtmlString(sprintf(
            '<div class="ig-finance-preview-card">
                <span class="ig-finance-badge ig-finance-badge--expense">Pengeluaran</span>
                <div class="ig-finance-preview-amount ig-finance-preview-amount--expense">%s</div>
                <dl>
                    <div><dt>Cabang</dt><dd>%s</dd></div>
                    <div><dt>Kategori</dt><dd>%s</dd></div>
                    <div><dt>Supplier</dt><dd>%s</dd></div>
