        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('balance')
                    ->label('Saldo')
                    ->state(fn ($record): string => FinanceBook::rupiah(FinanceBook::runningIncomeBalance($record)))
                    ->alignEnd()
                    ->weight('bold')
                    ->width('160px'),
            ...
            ->emptyStateDescription('Saat ada kas masuk, tabel ini akan tampil sebagai buku kas debit dengan saldo berjalan.');
    }
}
