...
class MasterDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        foreach ([
            ...
            ['slug' => 'raw-clean', 'name' => 'Raw Clean', 'category_type' => 'raw_material'],
            ['slug' => 'wip', 'name' => 'WIP', 'category_type' => 'wip'],
            ['slug' => 'premix', 'name' => 'Premix', 'category_type' => 'wip'],
        ...
        $items = [
            ...
            ['sku' => 'RM-BAPUT', 'name' => 'Bawang Putih', 'category' => 'raw-clean', 'unit' => 'KG', 'stage' => ItemStageCode::RawClean->value, 'type' => 'material'],
            ['sku' => 'RM-MINYAK', 'name' => 'Minyak', 'category' => 'raw-clean', 'unit' => 'LTR', 'stage' => ItemStageCode::RawClean->value, 'type' => 'material'],
            ['sku' => 'RM-PENYEDAP', 'name' => 'Penyedap', 'category' => 'premix', 'unit' => 'GR', 'stage' => ItemStageCode::RawClean->value, 'type' => 'premix'],
            ['sku' => 'RM-MICIN', 'name' => 'Micin', 'category' => 'premix', 'unit' => 'GR', 'stage' => ItemStageCode::RawClean->value, 'type' => 'premix'],
            ['sku' => 'RM-GARAM', 'name' => 'Garam', 'category' => 'premix', 'unit' => 'GR', 'stage' => ItemStageCode::RawClean->value, 'type' => 'premix'],
            ['sku' => 'RM-LADA', 'name' => 'Lada', 'category' => 'premix', 'unit' => 'GR', 'stage' => ItemStageCode::RawClean->value, 'type' => 'premix'],
            ['sku' => 'RM-GULA', 'name' => 'Gula', 'category' => 'premix', 'unit' => 'GR', 'stage' => ItemStageCode::RawClean->value, 'type' => 'premix'],
            ['sku' => 'WIP-PREMIX', 'name' => 'Premix Bumbu', 'category' => 'premix', 'unit' => 'KG', 'stage' => ItemStageCode::Wip->value, 'type' => 'premix'],
        ...
        foreach ($items as $item) {
            Item::query()->updateOrCreate(['sku' => $item['sku']], [
                ...
                'item_type' => $item['type'],
                'requires_production' => in_array($item['type'], ['premix', 'semi_finished', 'product'], true),
                'minimum_stock' => 10,
